...
I found that 5 epochs are more than sufficient as we reach the maximum validation accuracy shown in figure [x]. If we 
...
results from the hyper parameter tuning as well as the proposed learning rate being the default one provided by the 
TensorFlow API.
...
Where \(TP\) is number of true positives and \(FP\) is the number of false negatives ().
