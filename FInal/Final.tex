...
on mobile devices. This will be done by implementing classical ML algorithms that are effective in image 
...
cameras, sensors, displays and mobile processors. Each of these are resources that an ML model can take advantage of.
