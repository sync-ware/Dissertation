...
\begin{itemize}
    \item Distributed Representation: These are used to represent objects within a more compact and dense manner, 
...
tackle the sparsity problem as they are harder to model (\cite{Brownlee2017}).
    \item Deep Architecture: The idea of layering to represent neurons in a human brain. You can imagine it as a map of 
...
as:
\begin{itemize}
    \item Binary classification e.g. it’s a flower or it’s not a flower.
